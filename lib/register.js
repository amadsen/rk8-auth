...
function authenticate (regSocket, authenticationPublicKeyOpts, done) {
  ...
  if(reg){
    ...
    regSocket.login( function(err, raw_credentials) {
      ...
      reg.pki.authenticationPublicKey = reg.pki.authenticationPublicKey || authenticationPublicKeyOpts.key;
      ...
      var credential_string = JSON.stringify({
          ...
          credentials = rk8pki.encrypt( credential_string, reg.pki.authenticationPublicKey );
